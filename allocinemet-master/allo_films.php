  ...
  <div class="row nopadding" id="liste_films">
    ...
    <div class="col-lg-9 col-md-8 col-sm-8">
      <div class="liens_films fadeInUp animated">
        ...
        <a href="content.php?id=1"><img class="effect " src="img/captain.jpeg" id="action">
          <p>Captain Marvel</p>
        </a>
        <a href="content.php?id=2"><img class="effect " src="img/creed.jpeg" id="science-fiction">
          <p>creed 2</p>
        </a>
        <a href="content.php?id=3"><img class="effect " src="img/av.jpg" id="horreur">
        ...
        <a href="content.php?id=7"><img class="effect " src="img/7.jpg" id="action">
          <p>blablabla</p>
        </a>
        <a href="content.php?id=8"><img class="effect " src="img/10.jpg" id="science-fiction">
          <p>blablabla</p>
        </a>
      </div>
    </div>
